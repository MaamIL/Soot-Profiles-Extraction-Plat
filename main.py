...
class Config:
    ...
    def __init__(self):
        ...
        self.root_dir = 'C:/Users/User/Documents/GenerateData/GeneratedData_Extra'  # Path to your dataset GeneratedData / GeneratedData_Extra / try
    ...
    # Params for model training
        ...
        self.optimizer = "torch.optim.Adam(self.parameters(), lr=self.config.lr, weight_decay=1e-4)"
        self.scheduler = ""
